export default {
  ...
  collectableSolver: {
    ...
    errors: {
      ...
      memoCapacity: { title: 'メモリ不足のため計算を完了できません', desc: 'この条件では、この端末で収集品判断に使えるメモリ上限に達しました。条件を絞るか、より単純な状況でお試しください。', raiseBudget: 'リスクを承知してメモリを増やす', manualRisk: '警告：メモリを増やすとブラウザが遅くなったり、タブが応答しなくなったり、システムに閉じられる可能性があります。' },
