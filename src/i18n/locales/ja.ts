  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: '採集そのものはプレイヤーがゲーム画面のメニューをクリックして行う必要があるため、申し訳ありませんが、マクロだけで採集作業をすべて完了することはできません。また、収集品システムもマクロには対応していません。画面上の実際の状態を見て、次に行うアクションを判断する必要があるためです。'
      },
      {
  ...
  collectableSolver: {
    ...
    debug: {
      ...
      stateFields: {
        ...
        scrutinyActive: '集中検分が有効かどうか。次の収集品精選アクションの価値上昇に影響します。',
        collectorsFocusActive: 'バリューフォーカスが有効かどうか。価値上昇率に影響します。',
