...
| 分類 | 採掘師 | 園藝師 | 英文/內部概念 | GP | 模型規則 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 採集 | 收藏品採集 | 收藏品採集 | Collect | 0 | 依目前收藏價值採集 1 個收藏品；成功時取得 reward、失敗時 reward 為 0，兩者都消耗 1 點耐久。 |
| 提煉 | 提煉 | 提煉 | Scour | 0 | 使用獲得力公式提高收藏價值，消耗 1 點耐久。 |
| 提煉 | 慎重提煉 | 慎重提煉 | Meticulous | 0 | 提升量為 Scour 的 75%；可能不消耗耐久；受 `Collector's Standard`、`Scrutiny` 與價值提升影響。 |
| Buff | 集中檢查 | 集中檢查 | Scrutiny | 200 | 下一次提煉類技能增加收藏價值，上升量依鑑別力公式計算，提煉後消耗；收藏價值已滿時遊戲內不可施放。 |
| Buff | 價值矚目 | 價值矚目 | Collector's Focus | 100 | 下一次提煉類技能的價值提升率乘 1.75 並 floor，上限 100%，提煉後消耗；收藏價值已滿時遊戲內不可施放。 |
| Buff | 預備碰觸 | 預備碰觸 | Priming Touch | 100 | 下一次慎重提煉不消耗耐久率翻倍；不會被 Scour 消耗，只在 Meticulous 後消耗；收藏價值已滿時遊戲內不可施放。 |
| 採集成功率 | 敏銳視野 / II / III | 環境探知 / II / III | successI/II/III | 50 / 100 / 250 | 若 Collect 成功率未滿 100%，可提高整個採集點的收藏品採集成功率。 |
| 採集成功率 | 明晰視野 | 植被專精 | nextCollectSuccess | 50 | 只提高下一次 Collect 成功率。 |
| 恢復耐久 | 石工之理 | 農夫之智 | restoreIntegrity | 300 | 耐久未滿時恢復 1 點；90 級以上 50% 機率附加理智同興預備。 |
| 恢復耐久 | 理智同興 | 理智同興 | Wise to the World | 0 | 有理智同興預備且耐久未滿時優先使用，恢復 1 點耐久。 |
| 節點事件 | 再起 | 再起 | Revisit | 0 | 91 級以上納入；普通點 5%，限時點 8%，觸發時以滿 GP 重新評估後續 policy。 |

目前排除於收藏品秘笈推薦：

- **大膽提煉 / Brazen Prospector / Brazen Woodsman**：50% 到 150% 隨機分布與檔位機率尚未確認；取整順序已確認為最後再 `floor`；且收藏價值已滿時遊戲內不可施放。
...
- `Brazen` 的倍率、`Scrutiny`、價值提升等加成計算完成後，最後再 `floor` 成收藏值提升量。
