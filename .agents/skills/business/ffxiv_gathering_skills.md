...
| Buff | 集中檢查 | 集中檢查 | Scrutiny | 200 | 下一次提煉類技能增加收藏價值，上升量依鑑別力公式計算，提煉後消耗。 |
| Buff | 價值矚目 | 價值矚目 | Collector's Focus | 100 | 下一次提煉類技能的價值提升率乘 1.75 並 floor，上限 100%，提煉後消耗。 |
| Buff | 預備碰觸 | 預備碰觸 | Priming Touch | 100 | 下一次慎重提煉不消耗耐久率翻倍；不會被 Scour 消耗，只在 Meticulous 後消耗。 |
...
- **大膽提煉 / Brazen Prospector / Brazen Woodsman**：50% 到 150% 隨機分布、檔位與取整順序尚未確認。
