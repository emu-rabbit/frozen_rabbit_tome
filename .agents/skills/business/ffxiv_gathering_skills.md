...
採掘師與園藝師的普通採集技能為同一套效果與 GP 消耗，只是技能名稱不同。普通素材採集的策略演算目前只納入下列技能；收藏品與水晶相關技能先保留資料，不納入普通採集最佳化。

| 分類 | 採掘師 | 園藝師 | 效果 | GP | 演算規則 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 獲得率提高 | 敏銳視野 / II / III | 環境探知 / II / III | 令整個採集點的獲得率提高 5% / 15% / 50% | 50 / 100 / 250 | 僅對獲得率高於 1% 的道具有效；三者不可疊加，演算時只能選擇其中一個。 |
| 額外採集率提高 | 富礦的饋贈I / II | 沃土的饋贈I / II | 令整個採集點的額外採集獎勵發生率提高 10% / 30% | 50 / 100 | 僅對額外採集獎勵發生率高於 1% 的道具有效；兩者不可疊加，演算時只能選擇其中一個。 |
